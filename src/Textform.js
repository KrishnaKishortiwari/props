...
export default function Textform(props) {
  ...
  return (
    ...
    <>
      <h3 style={{color:props.mode==='dark'?'whie':'#042743'}}>{text}</h3>
      <form >
        <div className="mb-3" style={{color:props.mode==='dark'?'whie':'#042743'}} >
        ...
        <div className="mb-3 form-check" style={{color:props.mode==='dark'?'whie':'#042743'}}>
      ...
      <div className="container my-3">
        ...
        <p className="text-primary">{text.split(" ").length}words and {text.length}charecter</p>
      </div>
    </>
  );
}